...
Try {
    ...
    [String]$appName = 'QuickBooks Enterprise Desktop'
    [String]$appVersion = 'XX'
    [String]$appArch = ''
    [String]$appLang = 'EN'
    ...
    ## Variables: Script
    [String]$deployAppScriptFriendlyName = 'QuickBooks Desktop Enterprise'
    [Version]$deployAppScriptVersion = [Version]''
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-Process -Path "$dirFiles\QuickBooksEnterprise2X.exe" -Arguments "-s", "-a", "QBMIGRATOR=1", "MSICOMMAND=/s", "QB_PRODUCTNUM=XXXXXX", "QB_LICENSENUM=XXXXXXXXXXXXXXX"
        ...
        If (-not $useDefaultMsi) {
            #Show-InstallationPrompt -Message 'QuickBooks Desktop Enterprise 22.0 Installed Successfully!' -ButtonRightText 'OK' -Icon Information -NoWait
        }
    }
